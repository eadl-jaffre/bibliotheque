...
// @Description  Authentifie un utilisateur (etudiant/enseignant/particulier) ou un bibliothecaire.
// @Tags         Auth
// @Accept       json
// @Produce      json
// @Param        credentials  body      ConnexionRequest  true  "Identifiants de connexion"
// @Success      200          {object}  ConnexionResponse
// @Failure      400          {object}  ErrorResponse
// @Failure      401          {object}  ErrorResponse
// @Router       /connexion [post]
