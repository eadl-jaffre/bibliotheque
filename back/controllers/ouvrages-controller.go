...
// GetOuvrages godoc
// @Summary      Rechercher des ouvrages
// @Description  Recherche avancee des ouvrages (livres/revues) ou liste initiale sans filtres.
// @Tags         Ouvrages
// @Produce      json
// @Param        titre       query     string   false  "Titre"
// @Param        auteur      query     string   false  "Auteur"
// @Param        isbn        query     string   false  "ISBN"
// @Param        code_barre  query     string   false  "Code barre"
// @Param        code_revue  query     string   false  "Numero revue"
// @Param        disponible  query     boolean  false  "Filtrer disponibles"
// @Success      200         {array}   repositories.OuvrageResultat
